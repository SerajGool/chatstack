                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <select className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              ...
              <div className="max-w-2xl">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    {/* Enterprise Plan */}
                    <div className="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors relative bg-white">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  <Button variant="outline" className="border-gray-300 text-gray-600 hover:text-gray-900">Add Payment Method</Button>
                </div>
              </div>
            )}
            ...
            {activeTab === 'security' && (
              <div className="max-w-2xl">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                  ...
                  <Button variant="outline" className="border-gray-300 text-gray-600 hover:text-gray-900">Change Password</Button>
                </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <Button variant="outline" className="border-gray-300 text-gray-600 hover:text-gray-900">Enable 2FA</Button>
                  </div>
                </div>
              </div>
            )}
